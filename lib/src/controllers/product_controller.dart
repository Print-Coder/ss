...
class ProductController extends ControllerMVC {
  ...
  // bool isSameECom(Product product) {
  //   if (carts.isNotEmpty) {
  ...
  //     }).whenComplete(() {
  //       scaffoldKey?.currentState?.showSnackBar(SnackBar(
  //         content: Text(this_product_was_added_to_cart),
  //       ));
  //     });
  //   } else {
  ...
  //     });
  //     scaffoldKey?.currentState?.showSnackBar(SnackBar(
  //       content: Text(thisProductWasAddedToFavorite),
  //     ));
  //   });
  // }
  ...
  //     });
  //     scaffoldKey?.currentState?.showSnackBar(SnackBar(
  //       content: Text(thisProductWasRemovedFromFavorites),
  //     ));
  //   });
  // }
  ...
  //   listenForProduct(productId: _id, message: productRefreshedSuccessfuly);
  // }
