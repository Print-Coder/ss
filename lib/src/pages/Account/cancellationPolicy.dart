...
class CancellationPolicy extends StatefulWidget {
  @override
  _CancellationPolicyState createState() => new _CancellationPolicyState();
}
...
class _CancellationPolicyState extends State<CancellationPolicy> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarWithPop(context, "Cancellation Policy",
          needSearch: false, needCart: false, ispop: true),
      body: SafeArea(
        
        child: Center(
          child: InAppWebView(
            initialUrl: baseUrl + cancellationPolicy,
            initialHeaders: {},
