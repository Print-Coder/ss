...
class OrderDetailsRefund extends StatefulWidget {
  OrderData orderData;
  ...
  @override
  _OrderDetailsRefundState createState() => _OrderDetailsRefundState();
}

class _OrderDetailsRefundState extends State<OrderDetailsRefund>
                    ...
                    SingleChildScrollView(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          //     onTap: () {},
                          //     // Navigator.of(context).pushNamed("/OrderDetailsRefund"),
                          //     child: Container(
    ...
    return Row(
      ...
      children: <Widget>[
        Container(
          ...
          height:
              SizeConfig.h * (orderData.refund_type == "bank" ? 0.36 : 0.28),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              ...
              // Visibility( // add this
              //   child: Spacer(),
              //   visible:  orderData.status.toLowerCase() == "refunded" ,
              // ),
              sizeText(
                Text(
                  "Refunded Amount",
        ...
        Container(
          ...
          height: SizeConfig.h * (orderData.refund_id != null ? 0.36 : 0.3),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              ...
              Text(
                Helper.getOrderPrice(
                    double.parse((orderData.refund_amount ?? 0).toString())),
                style: Theme.of(context).textTheme.headline6.copyWith(
                      color: Colors.black,
                      fontSize: 15,
                    ),
