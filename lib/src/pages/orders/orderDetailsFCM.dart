...
class OrderDetailsFCM extends StatefulWidget {
  OrderData orderData;
  ...
  @override
  _OrderDetailsFCMState createState() => _OrderDetailsFCMState();
}

class _OrderDetailsFCMState extends State<OrderDetailsFCM>
