...
class OrderDetailsFCMRefund extends StatefulWidget {
  OrderData orderData;
  ...
  @override
  _OrderDetailsFCMRefundState createState() => _OrderDetailsFCMRefundState();
}

class _OrderDetailsFCMRefundState extends State<OrderDetailsFCMRefund>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarWithPop(context, "Order Details",
          needSearch: false, needCart: false, ispop: true, fcm: true),
